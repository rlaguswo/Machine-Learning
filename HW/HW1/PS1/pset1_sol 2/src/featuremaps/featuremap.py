...
def main(train_path, small_path, eval_path):
    ...
    run_exp(train_path, False, [3, 5, 10, 20], 'large-poly.png')
    run_exp(train_path, True, [0, 1, 2, 3, 5, 10, 20], 'large-sine.png')
    run_exp(small_path, True, [1, 2, 5, 10, 20], 'small-sine.png')
    run_exp(small_path, False, [1, 2, 5, 10, 20], 'small-poly.png')
    # *** END CODE HERE ***
